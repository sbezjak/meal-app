...
It's a PWA, so on a phone you can "Add to Home Screen" and it works offline like a real app.
...
[Astro](https://astro.build) + [`@vite-pwa/astro`](https://github.com/vite-pwa/astro), static output, deployed to GitHub Pages via GitHub Actions.
